...
## M1–M6 governing documents

Before implementing M1 or later, read and follow:

- `M1_M6_VALIDATED_RG_ROADMAP.md`
- `MATHEMATICAL_CERTIFICATION_SPEC.md`
- `CODEX_PROMPTS_M1_M6.md`

A milestone is complete only when its acceptance conditions pass. A feature being
implemented is not sufficient. Mathematical proof obligations override performance
or convenience. If a deterministic validation is missing, report `BLOCKED_MATH`
or `NOT_CERTIFIED`; never substitute a heuristic silently.
