...
| M7 | 実装・Paperspace 実行可 | Campaign A/B/C scheme search：`q_cert_upper<1` の独立検証済み scheme を探索 |
...
VALIDATED_RG_M7C_RUN_ID=M7-20260720T081500Z-c8d5f02b3c96  # Campaign C (S3)
```
...
へ進み、子 lineage を人間レビュー後に実行して独立検証します。
